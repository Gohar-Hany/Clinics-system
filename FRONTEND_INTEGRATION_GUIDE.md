...
- **واجهة تجربة الـ APIs التفاعلية (Interactive Swagger UI):** `http://localhost:8000/docs` 🚀 *(يمكنه فتح هذا الرابط وتجربة أي API بضغطة زر مباشرة من المتصفح)*
- **توثيق ReDoc المتقدم:** `http://localhost:8000/redoc`
