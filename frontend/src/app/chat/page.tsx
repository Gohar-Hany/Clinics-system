  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "أهلاً بحضرتك يا فندم في عيادتنا! 🌸\nأنا معاك لتنظيم حجزك ومتابعة دورك في العيادة بكل سهولة.\n\nتقدر تقولي حابب تحجز يوم إيه، أو تسألني عن دورك في الطابور وأنا تحت أمرك في أي وقت 😊",
      timestamp: new Date(),
    },
  ]);
