  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "أهلاً بحضرتك في عيادات النخبة. أنا معاك لمساعدتك في حجز موعدك أو متابعة دورك في العيادة.\n\nتقدر تقولي حابب تحجز يوم إيه، أو تستعلم عن دورك في الطابور وتحت أمرك في أي وقت.",
      timestamp: new Date(),
    },
  ]);
